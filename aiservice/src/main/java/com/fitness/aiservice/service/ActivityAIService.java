...
public class ActivityAIService {
	...
	private List<String> extractImprovements(JsonNode improvementsNode) {		
		...
		return improvements.isEmpty() ? Collections.singletonList("No specific imrpovements provided") : improvements;
	}
	...
	private String createPromptForActivity(Activity activity) {
		...
		return String.format("""
				...
				Provide detailed analysis focusing on performance, improvements, next workout suggenstions, and safety guidelines. 
